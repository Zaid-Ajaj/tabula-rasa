...
let draftActions isDeleting isPublishing (draft : BlogPostItem) dispatch =
    [ button [ ClassName "btn btn-info"
      ...
      button [ ClassName "btn btn-success"
               ...
               Style [ Margin 5 ] ] [ span [] [ Common.icon isPublishing "rocket"
                                                str "Publish" ] ]
      button [ ClassName "btn btn-danger"
               Style [ Margin 5 ]
               OnClick(fun _ -> dispatch (AskPermissionToDeleteDraft draft.Id)) ] [ span [] [ Common.icon isDeleting 
                                                                                                  "times"
                                                                                              str "Delete" ] ] ]
            ...
            [ h1 [] [ str "Drafts" ]
              ...
              table [ ClassName "table table-bordered" ] 
                  [ thead [] [ tr [] [ th [] [ str "ID" ]
                                       ...
                                       th [] [ str "Slug" ]
                                       th [] [ str "Actions" ] ] ]
                    tbody [] [ for draft in loadedDrafts -> 
