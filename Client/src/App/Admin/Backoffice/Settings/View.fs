...
let blogSettingsEditor (blogInfo : BlogInfo) dispatch =
    form [] [ div [ ClassName "form-group" ] [ label [ HtmlFor "txtBlogTitle" ] [ str "Blog Title" ]
              ...
              div [ ClassName "form-group" ] [ label [ HtmlFor "txtBlogBio" ] [ str "Biography" ]
                                               input [ ClassName "form-control form-control-lg"
                                                       Id "txtBlogBio"
                                                       Key "txtBlogBio"
                                                       Type "text"
              ...
              div [ ClassName "form-group" ] [ label [ HtmlFor "txtBlogName" ] [ str "Name" ]
                                               input [ ClassName "form-control form-control-lg"
                                                       Id "txtBlogName"
                                                       Key "txtBlogName"
                                                       Type "text"
              ...
              div [ ClassName "form-group" ] [ label [ HtmlFor "txtProfileImgUrl" ] [ str "Profile Image Url" ]
                                               input [ ClassName "form-control form-control-lg"
                                                       Id "txtProfileImgUrl"
              ...
              div [ ClassName "form-group" ] [ label [ HtmlFor "txtAbout" ] [ str "About" ]
...
let userSettings state dispatch =
    form [] [ div [ ClassName "form-group" ] [ label [ HtmlFor "txtCurrentPassword" ] [ str "Current Password" ]
                                               input [ ClassName "form-control form-control-lg"
                                                       ...
                                                       Type "password" ] ]
              div [ ClassName "form-group" ] [ label [ HtmlFor "txtNewPassword" ] [ str "New Password" ]
                                               input [ ClassName "form-control form-control-lg"
                                                       Id "txtNewPassword"
                                                       Key "txtNewPassword"
                                                       ...
                                                       Type "password" ] ]
              div [ ClassName "form-group" ] [ label [ HtmlFor "txtNewPasswordConfirm" ] [ str "Confirm New Password" ]
                                               input [ ClassName "form-control form-control-lg"
...
let tabs state dispatch =
    ul [ ClassName "nav nav-tabs" ] 
        [ li [ ClassName "nav-item" ] [ div [ classNames [ "nav-link", true
                                                           "active", not state.ShowingUserSettings ]
                                              Style [ FontSize 18
                                                      Cursor "pointer" ]
                                              OnClick(fun _ -> dispatch ShowBlogSettings) ] [ str "Blog Settings" ] ]
          li [ ClassName "nav-item" ] [ div [ classNames [ "nav-link", true
                                                           "active", state.ShowingUserSettings ]
                                              Style [ FontSize 18
                                                      Cursor "pointer" ]
                                              OnClick(fun _ -> dispatch ShowUserSettings) ] [ str "Change Password" ] ] ]

let settings state blogInfo dispatch =
    if not state.ShowingUserSettings then 
        div [ Style [ Padding 10 ] ] [ blogSettingsEditor blogInfo dispatch
                                       button [ ClassName "btn btn-success"
                                                OnClick(fun _ -> dispatch SaveChanges) ] [ str "Save Changes" ] ]
    else 
        div [ Style [ Padding 10 ] ] 
            [ userSettings state dispatch
              button [ ClassName "btn btn-success"
                       OnClick(fun _ -> dispatch SubmitNewPassword) ] [ str "Change Password" ] ]
