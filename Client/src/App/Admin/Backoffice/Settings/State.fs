...
let update authToken msg state =
    ...
    | LoadBlogInfo -> 
        ...
        let loadBlogInfoCmd =
            Cmd.fromAsync { Value = Server.api.getBlogInfo()
        ...
        | Body blogInfo -> 
            ...
            | SaveChanges -> 
                ...
                let updateBlogInfoCmd =
                    Cmd.fromAsync { Value = Server.api.updateBlogInfo request
                                    Error =
            ...
            | SubmitNewPassword when String.IsNullOrWhiteSpace state.ConfirmNewPassword 
            ...
            | SubmitNewPassword -> 
                ...
                let updatePwdCmd =
                    Cmd.fromAsync { Value = Server.api.updatePassword updatePwdInfo
                                    Error =
                                        fun ex -> 
                                            UpdatePasswordError "Network error occured while updating your password"
                                    Success =
                                        function 
            ...
            | UpdatePasswordSuccess -> 
                // reset input fields
                let nextState =
                    { state with IsUpdatingPassword = false
                                 NewPassword = ""
                                 CurrentPassword = ""
                                 ConfirmNewPassword = "" }
