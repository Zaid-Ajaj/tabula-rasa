...
let render currentPage (state: State) dispatch = 
    ...
    | Login ->
        ...
        | Some _ -> 
            Backoffice.View.render Backoffice.Types.Page.Home state.Backoffice (BackofficeMsg >> dispatch)
    | Backoffice backofficePage ->
        ...
        | Some _ ->
            Backoffice.View.render backofficePage state.Backoffice (BackofficeMsg >> dispatch)
