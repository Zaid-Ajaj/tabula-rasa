...
let adminMenuItems state dispatch =
    [ menuItem
        "Home"
        (Page.Admin(Admin.Types.Page.Backoffice(Admin.Backoffice.Types.Page.Home)))
        state.CurrentPage
        dispatch

      menuItem
          "Published Posts"
          (Page.Admin(Admin.Types.Page.Backoffice(Admin.Backoffice.Types.Page.PublishedPosts)))
          state.CurrentPage
          dispatch

      menuItem
          "Drafts"
          (Page.Admin(Admin.Types.Page.Backoffice(Admin.Backoffice.Types.Page.Drafts)))
          state.CurrentPage
          dispatch

      menuItem
          "New Article"
          (Page.Admin(Admin.Types.Page.Backoffice(Admin.Backoffice.Types.Page.NewPost)))
          state.CurrentPage
          dispatch

      menuItem
          "Settings"
          (Page.Admin(Admin.Types.Page.Backoffice(Admin.Backoffice.Types.Page.Settings)))
          state.CurrentPage
          dispatch ]
